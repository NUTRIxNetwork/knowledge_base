---
title: NUTRIx — Network for Computational Nutrition Science
hide:
  - toc
---
...
<figure markdown="span">
  ![Funded by the Deutsche Forschungsgemeinschaft (DFG)](assets/dfg-logo.gif#only-light){ width="300" }
  ![Funded by the Deutsche Forschungsgemeinschaft (DFG)](assets/dfg-logo-dark.gif#only-dark){ width="300" }
  <figcaption>
