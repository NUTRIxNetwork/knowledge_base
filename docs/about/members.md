...
The network comprises postdoctoral fellows, (junior) group leaders, and advanced
doctoral candidates across nutrition, epidemiology, and data science.

!!! note "Placeholder entries"
    Each entry below is a placeholder built from public affiliation and research
    information. Members: add a photo, a short bio, links (website, ORCID,
    GitHub/GitLab, Mastodon/LinkedIn), and correct anything that is out of date.
    No contractual or other confidential personal information is stored here.

## Coordinators

<div class="grid cards" markdown>

- __Dr. Mattea Müller__

    Peter L. Reichertz Institute for Medical Informatics, Hannover Medical School (MHH)
...
- __Sander Janssen, MSc__
    ...
    Department of Information Technology, Wageningen University & Research;
    Department of Primary and Community Care, Radboud UMC
...
- __Dr. Stefan Konigorski__
    ...
    Department of Computational Precision Nutrition, German Institute of Human
    Nutrition Potsdam-Rehbrücke (DIfE)

    *Research interests:* precision nutrition, personalised medicine, causal
...
- __Dr. Kristin Krüger__
    ...
    Institute of Nutritional Behaviour
...
- __Prof. Tilman Kühn__
    ...
    Department of Nutritional, Food and Consumer Sciences, Fulda University of
    Applied Sciences
...
- __Clarissa Spiegler, MSc__
    ...
    *Research interests:* dietary intake data, child nutrition, survey statistics
    and data analysis

    *Network role:* supports the 2028 meeting; practical input on preparing dietary
    intake data for analysis

- __Dr.-Ing. Jan Voges__

    Institute for Information Processing & L3S Research Center, Leibniz University
    Hannover

    *Research interests:* AI methods for multi-omics data analysis and their
...
- __Jun.-Prof. Dr. Silvio Waschina__
    ...
    Science, Kiel University (Christian-Albrechts-Universität zu Kiel)

    *Research interests:* nutriinformatics, microbiome–diet interactions,
...
!!! note "Placeholder"
    A directory of associated researchers and guest experts will be added here to
    support national and international collaboration beyond the core network.
